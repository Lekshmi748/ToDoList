...
$('#welcomeText').html(`Hello ${currentUser.uname}! <br> Welcome to your 'To Do' List`);
...
const getList=async ()=>{
    try{
        ...
        lists.forEach((el,index)=>{
            listcontent+=`<li class="list-group-item ${el.completed?'disabledList':''} ${index%2?'list-group-item-info':'list-group-item-success'}"> <input type="checkbox" class="checkbox" ${el.completed?' checked':''}/> <label for=""> ${el.title}</label>
